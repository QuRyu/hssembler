...
/* package assembler-0.1.0.0 */
#define VERSION_assembler "0.1.0.0"
#define MIN_VERSION_assembler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "assembler-0.1.0.0"

#define CURRENT_PACKAGE_KEY "assembler-0.1.0.0"
